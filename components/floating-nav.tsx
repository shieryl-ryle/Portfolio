          ...
          {isMobile ? (
            <div className="relative flex items-center justify-between">
              <Link href="/" className="font-bold text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">Shieryl</span>
                <span className="text-white">Tendilla</span>
              </Link>
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="relative flex items-center gap-1">
              <Link href="/" className="font-bold text-lg mr-4">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">Shieryl</span>
                <span className="text-white">Ryle</span>
              </Link>
              {navItems.map((item) => (
                <Link
                  key={item.name}
