        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {data.posts.map((post, index) => (
            <a
              ...
              className="group block bg-secondary rounded-xl md:rounded-2xl border border-border overflow-hidden hover:border-accent hover:shadow-lg hover:shadow-accent/10 transition-all duration-300 cursor-pointer"
            >
              <article>
                ...
                <div className="p-4 md:p-5">
                  ...
                  {/* Read More Link */}
                  <div className="flex items-center gap-2 text-xs md:text-sm text-accent group-hover:gap-3 transition-all font-medium">
                    Read More
